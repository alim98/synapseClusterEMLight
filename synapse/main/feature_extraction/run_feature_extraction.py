...
try:
    ...
    from synapse.main.feature_extraction.FeatureExtraction import FeatureExtraction
...
def run_feature_extraction(seg_types=[11, 13], alpha=1.0):
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        run_feature_extraction(seg_types=[10,12])
    except Exception as e:
